...
// adicionando plainbutton no jframe 
      add(plainJButton); // add plainJButton to JFrame
// quando tem operador de atribuição tem declaração de variavel      
      Icon bug1 = new ImageIcon(getClass().getResource("bug1.gif"));
// vai pegar o recurso  dentro da classe e transformar em imageicon      
...
// handler é o manipulador, o comando que faz quando clicamos      
   ...
   // buttonhandler injetou actionlistener 
